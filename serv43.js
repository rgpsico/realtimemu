...
const options = {
    key: fs.readFileSync("/etc/letsencrypt/live/www.comunidadeppg.com.br/privkey.pem"),
    cert: fs.readFileSync("/etc/letsencrypt/live/www.comunidadeppg.com.br/fullchain.pem")
};
