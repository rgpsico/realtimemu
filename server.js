...
app.post("/atualizar_aluno", (req, res) => {
  ...
  res.json({
    mensagem: "Dados recebidos com sucesso no outro canal!2",
    seusDados: req.body,
  });
});
...
app.post("/atualizar_data_vencimento_aluno", (req, res) => {
  console.log(
    "atualizar_data_vencimento_aluno so data de vencimento" + req.body.empresa,
    req.body
  );
  io.emit("atualizar_data_vencimento_aluno" + req.body.empresa, req.body);

  res.json({
    mensagem: "Dados recebidos com sucesso noaaa outro canal!",
    seusDados: req.body,
  });
});
...
app.post("/atualizar_aluno_catraca", (req, res) => {
  console.log(
    "atualizar_aluno_catraca so data de vencimento" + req.body.empresa,
    req.body
  );
  io.emit("atualizar_aluno_catraca" + req.body.empresa, req.body);

  res.json({
    mensagem: "Dados recebidos atualizar_aluno_catraca",
    seusDados: req.body,
  });
});
...
app.post("/atualizar_aluno_gympass", (req, res) => {
  ...
  res.json({
    mensagem: "Dados recebidos com sucesso atualizar_aluno_gympass!",
    seusDados: req.body,
  });
});
...
app.post("/atualizar_aluno_totalpass", (req, res) => {
  ...
  res.json({
    mensagem: "Dados recebidos com sucesso tualizar_aluno_totalpass!",
    seusDados: req.body,
  });
});
...
app.post("/sincronizar_funcionario", (req, res) => {
  ...
  res.json({
    mensagem: "funcinários sincronizados com sucesso!",
    seusDados: req.body,
  });
});
